...
require File.expand_path('lib/lokalise-rails/version', __dir__)

Gem::Specification.new do |spec|
  spec.name                  = 'lokalise-rails'
  ...
  spec.homepage              = 'https://github.com/bodrovis/lokalise-rails'
  spec.license               = 'MIT'
  ...
  spec.files = Dir['README.md', 'LICENSE',
                   'CHANGELOG.md', 'lib/**/*.rb',
                   'lokalise-rails.gemspec', '.github/*.md',
                   'Gemfile', 'Rakefile']
